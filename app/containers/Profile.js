...
const UserProfileScreen = () => {
  ...
  const [associationAddress, setAssociationAddress] = useState("Location");
  const [associationEmail, setAssociationEmail] = useState("user@email.com");
  ...
  React.useEffect(() => {
    fetch(`http://${ip}:5050/users/${id}`)
      .then((res) => res.json())
      .then((data) => {
        setAssociationEmail(data.email)
        setAssociationAddress(data.addresse)
        setAssociationPassword(data.pass)
  ...
  const onSubmitEdit = () => {
      ...
      { 
        ...
        ToastAndroid.showWithGravity(
          ...
          if(associationPassword===password3){
           ...
           if(password!=null)
            { if (password===password2){
              ...
              .then(response => response.json())
              .then(json => console.log(json))
              setAssociationPassword(password)
    ...
    <SafeAreaView style={styles.container}>
            ...
            {clicked? <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.infoContainer}>
                   ...
                   { association && <View style={styles.row}>
                    ...
                    {association? <View style={styles.row}>
                      ...
                      {associationRating<0 ?<RateIcon name="emoji-sad" color="#777777" size={20}/> : null}
               ...
               {shouldShowPosts? ( <View style={{ marginTop: 32 }}>
                ...
                {shouldShowEvents? ( <View style={{ marginTop: 32 }}>
                  <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
                        <View style={styles.mediaImageContainer}>
                            <Image source={require("../assets/imgs/event4.jpeg")} style={styles.image} resizeMode="cover"></Image>
                        </View>

                        <View style={styles.mediaImageContainer}>
                            <Image source={require("../assets/imgs/event5.jpg")} style={styles.image} resizeMode="cover"></Image>
                        </View>

                        <View style={styles.mediaImageContainer}>
                            <Image source={require("../assets/imgs/event1.jpg")} style={styles.image} resizeMode="cover"></Image>
                        </View>
                        <View style={styles.mediaImageContainer}>
                            <Image source={require("../assets/imgs/event2.jpg")} style={styles.image} resizeMode="cover"></Image>
                        </View>
                        <View style={styles.mediaImageContainer}>
                            <Image source={require("../assets/imgs/event3.jpg")} style={styles.image} resizeMode="cover"></Image>
                        </View>
                        <View style={styles.mediaImageContainer}>
                            <Image source={require("../assets/imgs/event4.jpeg")} style={styles.image} resizeMode="cover"></Image>
                        </View>
