  ...
  render(){ 
    ...
    return(
      <ScrollView>
        ...
        <View style={styles.service} onTouchEnd={()=>this.props.navigation.navigate('Home', {
            // user:   this.props.user,
            token:  this.props.token
          })} >
        ...
        <View style={styles.service}  >
          <AntDesign name="star" color={"#1b59a2"} size={30}/>
          <View style={styles.srvDescWrap}>
            <Text style={styles.srvTitle} >Evènements Favoris</Text>
          </View>
        </View> 
